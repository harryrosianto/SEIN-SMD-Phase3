...
namespace SampleUI_SamsungAGV
{
    public partial class Form1 : Form
    {
        ...
        {
            giveUpJobID g = new giveUpJobID();
            g.ShowDialog();
            jobIDInput = giveUpJobID.jobIDValue;
        ...
        private async void bunifuButton1_Click(object sender, EventArgs e)
        {
            try
            {
                await API("missionC.netMissionAdd('CLEAR TRAFFIC')");
            }
            catch (Newtonsoft.Json.JsonSerializationException)
            {
                AutoClosingMessageBox.Show("don't click 'OK' until clearing traffic process is finish", "TRAFFIC INFO", 8000);
                trafficForm t = new trafficForm();
                t.ShowDialog();
                string cancelTrafficJob = "missionC.netMissionCancel(" + trafficJob + ")";
                await API(cancelTrafficJob);
            }
        ...
        private static void batteryLevel1_ProgressChanged1(object sender, Bunifu.UI.WinForms.BunifuProgressBar.ProgressChangedEventArgs e)
        {

        }

        private static void closeButton_Click1(object sender, EventArgs e)
        {
            Application.Exit();
        }

        private static void writeLog(string logTime, string logName, long logJobid, string logStatusDlv)
        {
        ...
        private static void batteryLevel2_ProgressChanged1(object sender, Bunifu.UI.WinForms.BunifuProgressBar.ProgressChangedEventArgs e)
        {

        }

        private static void disini(string textInput, string i2, string i3)
        {
            //Console.WriteLine("Lagi Disini : {0}, {1}, {2}", textInput,i2,i3);
        }

        private void timer3_Tick1(object sender, EventArgs e)
        {
            moveCnt += 1;

        }

        private static void detailError_Click1(object sender, EventArgs e)
        {
        ...
        private static void detailDelivery_Click1(object sender, EventArgs e)
        {
        ...
        private static void timer4_Tick1(object sender, EventArgs e)
        {
        ...
        private void timer5_Tick1(object sender, EventArgs e)
        {
            waitingTime += 1;
        }
    }
